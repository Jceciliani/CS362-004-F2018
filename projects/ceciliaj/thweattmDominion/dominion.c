...
/********************************************************
******** START OF SEPARATE CARD IMPLEMENTATIONS *********
********************************************************/

//Card 1: Adventurer Card
...
int mineCard(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos){
	...
	//BUG INTRODUCED HERE
	//ORIGINAL LINE: 'if (choice2 > treasure_map || choice2 < curse){'
	...
	for (i = 0; i < state->numPlayers; i++){
		...
		if (i == currentPlayer){
			...
			for (j = 0; j < state->handCount[i]; j++){
				...
				//Debug statement to display all remaining cards in hand
				//to verify all copper has been removed
...
/********************************************************
********* END OF SEPARATE CARD IMPLEMENTATIONS **********
********************************************************/
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  int i;
  int j;
  //int k; //No longer used with catpurse separated out
  int x;
  int index;
  int currentPlayer = whoseTurn(state);
  ...
  //int drawntreasure=0; //No longer used with adventurer separated out
  //int cardDrawn; //No longer used with adventurer separated out
  //int z = 0;// this is the counter for the temp hand //No longer used with adventurer separated out
  ...
  switch( card ) 
	...
	********************************************************/
    case adventurer: 
		...
		//Adventurer card moved to separated implementation (above this function)
	...
	********************************************************/
    case mine:
		...
		//Mine card moved to separated implementation (above this function)
		//Original code commented out above for preservation/reference
	...
	********************************************************/
    case smithy: 
      //+3 Cards
		...
		//Smithy card moved to separated implementation (above this function)
		//Original code commented out above for preservation/reference
